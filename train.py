...
def parse_args():
    ...
    # basic parameters
    #===================================================dataset parameters=============================================================================
    parser.add_argument('--dataset_name', type=str, default='JNU', help='the name of the dataset：CWRU、SEU、XJTU、JNU、MFPT、UoC、DC')
    parser.add_argument('--dataset_path', type=str, default=r"E:\故障诊断数据集\江南大学轴承数据(一)\数据", help='the file path of the dataset')
    ...
    parser.add_argument('--sample_num', type=int, default=600,help='the number of samples')
    ...
    parser.add_argument('--overlap', type=int, default=512, help='the sampling shift of neibor two samples')
    ...
    parser.add_argument('--input_type', type=str, default='TFD',help='TD——time domain signal，FD——frequency domain signal')
    ...
    parser.add_argument('--node_num', type=int, default=12, help='the number of node in a graph')
    ...
    # ===================================================model parameters=============================================================================
    parser.add_argument('--model_type', type=str, default='GDC_LSTM', help='the model of training and testing')
    ...
    parser.add_argument('--output_path', type=str, default=output_path, help='output_path')
